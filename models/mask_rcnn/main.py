...
from models.centermask.centermask.evaluation.coco_evaluation import COCOEvaluator
from models.centermask.centermask.checkpoint.adet_checkpoint import AdetCheckpointer
